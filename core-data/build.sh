...
docker_args="-i  -v /var/run/docker.sock:/var/run/docker.sock -v $srcdir:/source-ro:ro -v $outdir:/output -e USER=$(id -u) -e GROUP=$(id -g)"
...
echo "Deleteing temporary build container : $build_container"
